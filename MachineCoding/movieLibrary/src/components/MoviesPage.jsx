    ...
    return(
        <div className="flex flex-col justify-center items-center">
            ...
            <input 
                ...
                className="border border-red-300 rounded p-3"
                name="SearchField"
                value={search}
            ...
            <div className="mt-20 grid grid-cols-3 gap-4">
                {movies.results.map((item, index)=>{
                    return(
                        <div className="flex flex-col justify-center items-center w-full h-full p-3 border border-slate-300 rounded-sm">
                            {item.title}
